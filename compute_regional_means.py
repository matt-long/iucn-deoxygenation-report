...
def tropical_hilat(index_ens):
    ...
    file_out = os.path.join(diro['out'],'toe_0glb_1trp_2hlt_upper1000m.ens_i_%03d.nc'%index_ens)
    ...
    file_out = os.path.join(diro['out'],'toe_0glb_1trp_2hlt_profile.ens_i_%03d.nc'%index_ens)
